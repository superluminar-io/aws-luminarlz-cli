/**
 * Contains a patched CliCredentialsSynthesizer.
 *
 * You can find the original here: https://github.com/aws/aws-cdk/blob/main/packages/aws-cdk-lib/core/lib/stack-synthesizers/cli-credentials-synthesizer.ts
 * And the open CDK issue here: https://github.com/aws/aws-cdk/issues/29071
 */
import {
  ...
  implements IReusableStackSynthesizer, IBoundStackSynthesizer
{
  ...
  constructor(
    private readonly props: CliCredentialsStackSynthesizerProps = {},
  ) {
    super();
    ...
    function validateNoToken<
      A extends keyof CliCredentialsStackSynthesizerProps,
    >(key: A) {
  ...
  public reusableBind(stack: Stack): IBoundStackSynthesizer {
    ...
    const copy = Object.create(this) as CliCredentialsStackSynthesizer;
